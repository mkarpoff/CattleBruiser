...
public:
	...
	enum WorkerJob {Minerals, Gas, Build, Combat, Idle, Repair, Move, Scout, Camp, Default};
...
public:
	...
	bool					createCampers(int numOfCampersNeeded);
	...
	BWAPI::Unit *			getLeastValuableWorker();
